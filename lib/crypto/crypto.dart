...
class Cryptography
{
  ...
  static String encrypt({String? secretkey = _sharedkey, String? vector = _sharedkey, String? text})
  {
    ...
    PaddedBlockCipher cipher = PaddedBlockCipherImpl(PKCS7Padding(), CBCBlockCipher(AESEngine()));
  ...
  static String? decrypt({String? secretkey = _sharedkey, String? vector = _sharedkey, String? text})
  {
