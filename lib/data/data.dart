...
class Data with ListMixin<dynamic>
{
  ...
  static List<String> cities = ["Tokyo","Japan","Jakarta","Delhi","Guangzhou","Guangdong","Mumbai","Mahārāshtra","Manila","Shanghai","São Paulo","Seoul","Mexico City","Cairo","New York","Dhaka","Beijing","Bangkok","Shenzhen","Moscow","Buenos Aires","Lagos","Istanbul","Karachi","Bangalore","Ho Chi Minh City","Ōsaka","Chengdu","Sichuan","Tehran","Rio de Janeiro","Toronto","Montreal"];
  static List<String> names   = ["John","William","James","Charles","George","Frank","Joseph","Thomas","Henry","Robert","Edward","Harry","Walter","Arthur","Fred","Albert","Samuel","David","Louis","Joe","Charlie","Clarence","Richard","Andrew","Daniel","Ernest","Will","Jesse","Oscar","Lewis","Peter","Benjamin","Frederick","Willie","Alfred","Sam","Roy","Herbert","Jacob","Tom","Elmer","Carl","Lee","Howard","Martin","Michael","Bert","Herman","Jim","Francis","Harvey","Earl","Eugene","Ralph","Ed","Claude","Edwin","Ben","Charley","Paul","Edgar","Isaac","Otto","Luther","Lawrence","Ira","Patrick","Guy","Oliver","Theodore","Hugh","Clyde","Alexander","August","Floyd","Homer","Jack","Leonard","Horace","Marion","Philip","Allen","Archie","Stephen","Chester","Willis","Raymond","Rufus","Warren","Jessie","Milton","Alex","Leo","Julius","Ray","Sidney","Bernard","Dan","Jerry","Calvin","Perry","Dave","Anthony","Eddie","Amos","Dennis","Clifford","Leroy","Wesley","Alonzo","Garfield","Franklin","Emil","Leon","Nathan","Harold","Matthew","Levi","Moses","Everett","Lester","Winfield","Adam","Lloyd","Mack","Fredrick","Jay","Jess","Melvin","Noah","Aaron","Alvin","Norman","Gilbert","Elijah","Victor","Gus","Nelson","Jasper","Silas","Christopher","Jake","Mike","Percy","Adolph","Maurice","Cornelius","Felix","Reuben","Wallace","Claud","Roscoe","Sylvester","Earnest","Hiram","Otis","Simon","Willard","Irvin","Mark","Jose","Wilbur","Abraham","Virgil","Clinton","Elbert","Leslie","Marshall","Owen","Wiley","Anton","Morris","Manuel","Phillip","Augustus","Emmett","Eli"];
  static List<String> surnames = ["Smith","Johnson","Williams","Brown","Jones","Miller","Davis","Garcia","Rodriguez","Wilson","Martinez","Anderson","Taylor","Thomas","Hernandez","Moore","Martin","Jackson","Thompson","White","Lopez","Lee","Gonzalez","Harris","Clark","Lewis","Robinson","Walker","Perez","Hall","Young","Allen","Sanchez","Wright","King","Scott","Green","Baker","Adams","Nelson","Hill","Ramirez","Campbell","Mitchell","Roberts","Carter","Phillips","Evans","Turner","Torres","Parker","Collins","Edwards","Stewart","Flores","Morris","Nguyen","Murphy","Rivera","Cook","Rogers","Morgan","Peterson","Cooper","Reed","Bailey","Bell","Gomez","Kelly","Howard","Ward","Cox","Diaz","Richardson","Wood","Watson","Brooks","Bennett","Gray","James","Reyes","Cruz","Hughes","Price","Myers","Long","Foster","Sanders","Ross","Morales","Powell","Sullivan","Russell","Ortiz","Jenkins","Gutierrez","Perry","Butler","Barnes","Fisher","Henderson","Coleman","Simmons","Patterson","Jordan","Reynolds"];
  static List<String> jobs = ["Veterinarian","Firefighter","Software Developer","Registered Nurse","Physician","Dentist","Engineer","Financial Manager","Lawyer","Electrician","Physician Assistant","Police Officer","Pharmacist","Civil Engineer","Nurse Practitioner","Actuary","Doctor","Architect","Accountant","Air Traffic Controller","Pilot","Plumber","Psychologist","Physical Therapist","Engineer","Manager","Hair Dresser","Realtor"];
  static List<String> companies = ["Apple","Microsoft","Saudi Aramco","Alphabet (Google)","Amazon","Berkshire Hathaway","NVIDIA","Meta Platforms (Facebook)","Tesla","Johnson & Johnson","Visa","Exxon Mobil","LVMH","UnitedHealth","TSMC","Tencent","Walmart","JPMorgan Chase","Eli Lilly","Novo Nordisk","Procter & Gamble","Mastercard","Nestlé","Samsung","Kweichow Moutai","Chevron","Home Depot","Merck","Coca-Cola","AbbVie","Pepsico","Broadcom","Oracle","L'Oréal","Roche","ASML","AstraZeneca","International Holding Company","Bank of America","ICBC","Hermès","Alibaba","Costco","Pfizer","Novartis","McDonald","Thermo Fisher Scientific","Shell","Reliance Industries","PetroChina","Salesforce","Nike","Cisco","Abbott Laboratories","China Mobile","Walt Disney","Toyota","Linde","Accenture","Danaher","Comcast","T-Mobile US","Adobe","Agricultural Bank of China","China Construction Bank","Dior","Verizon","SAP","TotalEnergies","Philip Morris","Nextera Energy","United Parcel Service","Wells Fargo","Texas Instruments","Morgan Stanley","Prosus","BHP Group","CATL","Netflix","Raytheon Technologies","Bank of China","AMD","HSBC","Tata Consultancy Services","Bristol-Myers Squibb","Unilever","Royal Bank Of Canada","Ping An Insurance","Sanofi","Honeywell","China Life Insurance","Starbucks","QUALCOMM","Siemens","HDFC Bank","Intel","Anheuser-Busch Inbev","Amgen","AT&T","AIA"];
}