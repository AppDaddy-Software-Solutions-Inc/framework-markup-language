...
class DetectableImage
{
  ...
  factory DetectableImage.fromCamera(CameraImage image, CameraDescription camera) => DetectableImage(null);
  factory DetectableImage.fromFilePath(String path) => DetectableImage(null);
  factory DetectableImage.fromRgba(List<int> bytes, int width, int height) => DetectableImage(null);
}