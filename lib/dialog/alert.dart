  ...
  Widget _getImage() {
    ...
    switch (type) {
      case Types.success:
        ...
        response = Icon(Icons.check_circle_outline_sharp, color: Colors.lightGreen, size: 64);
        break;
      case Types.error:
        ...
        response = Icon(Icons.error_outline_sharp, color: Colors.red, size: 64);
        break;
      case Types.info:
        ...
        response = Icon(Icons.info_outline_rounded, color: Colors.black87, size: 64);
        break;
      case Types.warning:
        ...
        response = Icon(Icons.warning_amber_sharp, color: Colors.amber, size: 64);
        break;
      case Types.none:
        response = Container();
        break;
