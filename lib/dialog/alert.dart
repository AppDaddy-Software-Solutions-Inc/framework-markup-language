...
class Alert {
  ...
  Widget _buildTitle() {
    ...
    var image = _getImage();
    var pad1 =
        isNullOrEmpty(this.title) ? Container() : const SizedBox(height: 15);
    var title = isNullOrEmpty(this.title)
        ? Container()
        : Text(this.title!,
            style: style.titleStyle, textAlign: style.titleTextAlign);
    var pad2 = isNullOrEmpty(this.desc)
        ? const SizedBox(height: 5)
        : const SizedBox(height: 10);
    var desc = isNullOrEmpty(this.desc)
        ? Container()
        : Text(this.desc!,
            style: style.descStyle, textAlign: style.descTextAlign);
    ...
    view = Center(
        child: Column(
          ...
          Padding(
              padding: pad0,
              child: Column(
                  children: <Widget>[image, pad1, title, pad2, desc, content]))
        ]));
  ...
  Widget _getImage() {
    ...
    switch (type) {
      case Types.success:
        ...
        response = const Icon(Icons.check_circle_outline_sharp,
            color: Colors.lightGreen, size: 64);
        break;
      case Types.error:
        ...
        response =
            const Icon(Icons.error_outline_sharp, color: Colors.red, size: 64);
        break;
      case Types.info:
        ...
        response = const Icon(Icons.info_outline_rounded,
      ...
      case Types.warning:
        ...
        response = const Icon(Icons.warning_amber_sharp,
