...
class Alert {
  ...
  Widget _buildTitle()
  {
    ...
    var image   = _getImage();
    var pad1    = isNullOrEmpty(this.title) ? Container() : const SizedBox(height: 15);
    var title   = isNullOrEmpty(this.title) ? Container() : Text(this.title!, style: style.titleStyle, textAlign: style.titleTextAlign);
    var pad2    = isNullOrEmpty(this.desc)  ? const SizedBox(height: 5) : const SizedBox(height: 10);
    ...
    view = Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[close,
  ...
  Widget _buildDialog()
  {
    ...
    final Widget myChild = ConstrainedBox(
      constraints: style.constraints ?? const BoxConstraints.expand(width: double.infinity, height: double.infinity), child: Align(alignment: style.alertAlignment,
      child: dialog));
  ...
  Widget _getImage() {
    ...
    switch (type) {
      case Types.success:
        ...
        response = const Icon(Icons.check_circle_outline_sharp, color: Colors.lightGreen, size: 64);
        break;
      case Types.error:
        ...
        response = const Icon(Icons.error_outline_sharp, color: Colors.red, size: 64);
        break;
      case Types.info:
        ...
        response = const Icon(Icons.info_outline_rounded, color: Colors.black87, size: 64);
        break;
      case Types.warning:
        ...
        response = const Icon(Icons.warning_amber_sharp, color: Colors.amber, size: 64);
        break;
      case Types.none:
        response = Container();
        break;
