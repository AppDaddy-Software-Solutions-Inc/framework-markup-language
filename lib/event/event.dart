...
enum EventTypes { alert, animate, back, build, clear, close, closeroute, complete, cont, copy, execute /* Executed by dot notation datasource events */, export, focusnode, home, keypress, signInWithJwt, logoff, signInWithFirebase, maximize, minimize, open, openjstemplate, openroute, page, post, quit, refresh, replace, replaceroute, reset, saveas, save, scroll, scrollto, set, showdebug, showlog, showtemplate, sort, sound, start, stash, stop, theme, toast, trigger, validate, wait }
