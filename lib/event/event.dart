...
enum EventTypes { alert, animate, back, build, clear, close, complete, cont, copy, execute /* Executed by dot notation datasource events */, export, faces, focusnode, home, keypress, logon, logoff, signin, maximize, minimize, ocr, open, page, post, quit, refresh, replace, save, scroll, scrollto, set, showdebug, showlog, showtemplate, sort, sound, start, stash, stop, theme, toast, trigger, validate, wait }
