...
class Bridge {
  ...
  final HashMap<String, List<OnMessageCallback>> _listeners =
      HashMap<String, List<OnMessageCallback>>();
  final id = newId();
  ...
  Map? _receive(dynamic event) {
    try {
      ...
      String? type =
          ((map.containsKey('message:type')) && (map['message:type'] is String))
              ? (map['message:type'] as String?)
              : null;
      String? from =
          ((map.containsKey('message:from')) && (map['message:from'] is String))
              ? (map['message:from'] as String?)
              : null;
      String? to =
          ((map.containsKey('message:to')) && (map['message:to'] is String))
              ? (map['message:to'] as String?)
              : null;
