...
class Template
{
  ...
  bool get isAutoGeneratedErrorPage => document != null ? Xml.hasAttribute(node: document!.rootElement, tag: errorPageAttribute) : false;

  Template({this.name, this.document});

  factory Template.fromXmlDocument({String? name, XmlDocument? xml, Map<String, String?>? parameters})
  {
  ...
  factory Template.fromFml({String? name, required String fml, Map<String, String?>? parameters})
  {
    var document = Xml.tryParse(fml);
    return Template.fromXmlDocument(name: name, xml: document, parameters: parameters);
  }

  factory Template.clone({required Template template, Map<String, String?>? parameters})
  {
    try
    {
  ...
  factory Template.error({required Template template, Map<String, String?>? parameters})
  {
    try
    {
      // Convert Xml Document to Xml String
