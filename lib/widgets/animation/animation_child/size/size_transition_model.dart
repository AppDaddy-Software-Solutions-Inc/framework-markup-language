...
class SizeTransitionModel extends AnimationChildModel implements IAnimatedWidget
{
  ...
  Widget getTransitionView(Widget child, {AnimationController? controller}) => SizeTransitionView(this, child, controller);
}
