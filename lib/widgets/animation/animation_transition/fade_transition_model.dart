...
import 'package:fml/widgets/animation/animation_transition/fade_transition_view.dart';
...
class FadeTransitionModel extends WidgetModel
{
  ...
  FadeTransitionModel(WidgetModel parent, String?  id) : super(parent, id); // ; {key: value}
