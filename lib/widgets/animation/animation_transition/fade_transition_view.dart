...
import 'package:fml/widgets/animation/animation_transition/fade_transition_model.dart' as MODEL;
...
class FadeTransitionView extends StatefulWidget
{
  ...
  FadeTransitionView(this.model, this.child, this.controller) : super(key: ObjectKey(model));

  @override
  FadeTransitionViewState createState() => FadeTransitionViewState();
}

class FadeTransitionViewState extends State<FadeTransitionView> with TickerProviderStateMixin implements IModelListener
{
