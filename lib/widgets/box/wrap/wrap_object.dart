...
class WrapObject extends MultiChildRenderObjectWidget {
  ...
  /// grouped together in the center of the overall [WrapObject] in the cross axis.
  ///
  /// Defaults to [WrapAlignment.start].
  ///
  /// See also:
  ...
  ///
  /// If there is additional free space in the overall [WrapObject] (e.g., because
  ...
  @override
  WrapRenderer createRenderObject(BuildContext context) {
    return WrapRenderer(
      model: model,
      direction: direction,
      alignment: alignment,
  ...
  @override
  void updateRenderObject(BuildContext context, WrapRenderer renderObject) {
    renderObject
      ..direction = direction
      ..alignment = alignment
      ..spacing = spacing
