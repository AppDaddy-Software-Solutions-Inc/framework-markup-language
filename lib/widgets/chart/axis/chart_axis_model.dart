...
class ChartAxisModel extends Model {
  ...
  set interval(dynamic v) {
    if (_interval != null) {
      ...
      _interval = StringObservable(Binding.toKey(id, 'interval'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set labelrotation(dynamic v) {
    if (_labelrotation != null) {
      ...
      _labelrotation = IntegerObservable(Binding.toKey(id, 'labelrotation'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set labelsize(dynamic v) {
    if (_labelsize != null) {
      ...
      _labelsize = IntegerObservable(Binding.toKey(id, 'labelsize'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set min(dynamic v) {
    if (_min != null) {
      ...
      _min = StringObservable(Binding.toKey(id, 'min'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set max(dynamic v) {
    if (_max != null) {
      ...
      _max = StringObservable(Binding.toKey(id, 'max'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
