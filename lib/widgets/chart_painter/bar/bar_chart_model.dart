...
class BarChartModel extends ChartPainterModel {
  ...
  static BarChartModel? fromTemplate(Model parent, Template template) {
    BarChartModel? model;
    try {
      XmlElement? xml =
          Xml.getElement(node: template.document!.rootElement, tag: "BARCHART");
  ...
  static BarChartModel? fromXml(Model parent, XmlElement xml) {
    BarChartModel? model;
    try {
  ...
  void deserialize(XmlElement xml) {
    ...
    // Set Series
    this.series.clear();
    List<BarChartSeriesModel> series =
        findChildrenOfExactType(BarChartSeriesModel)
            .cast<BarChartSeriesModel>();
