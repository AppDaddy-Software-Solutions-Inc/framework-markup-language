...
import 'package:fml/widgets/echart/series/chart_series_model.dart';
import 'package:fml/widgets/echart/label/chart_label_model.dart';
import 'package:fml/widgets/echart/axis/chart_axis_model.dart';
import 'package:fml/widgets/reactive/reactive_view.dart';
import 'package:fml/widgets/widget/model.dart';
import 'package:fml/widgets/echart/chart_view.dart';
...
class ChartModel extends BoxModel {
  ...
  void deserialize(XmlElement xml) {
    ...
    List<ChartSeriesModel> series =
        findChildrenOfExactType(ChartSeriesModel).cast<ChartSeriesModel>();
    ...
    // Set Labels
    this.labels.clear();
    List<ChartLabelModel> labels =
        findChildrenOfExactType(ChartLabelModel).cast<ChartLabelModel>();
