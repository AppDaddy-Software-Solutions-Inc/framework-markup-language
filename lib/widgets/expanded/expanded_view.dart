...
class _ExpandedViewState extends State<ExpandedView> implements IModelListener
{
  @override
  void initState()
  {
  ...
  /// Callback to fire the [_ExpandedViewState.build] when the [ExpandedModel] changes
  ...
  Widget build(BuildContext context)
  {
    ...
    //////////////////////////
    if ( (widget.model.parent != null) && ((widget.model.parent is RowModel) || (widget.model.parent is ColumnModel) ||(widget.model.parent is BoxModel) )) //check for stack here maybe if cont lay = stack
         return Expanded(flex: widget.model.flex, child: child);
