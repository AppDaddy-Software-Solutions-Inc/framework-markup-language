...
class _ListLayoutViewState extends WidgetState<ListLayoutView> implements IEventScrolling
{
  ...
  Widget builder(BuildContext context, BoxConstraints constraints)
  {
    ...
    if (constraints.maxHeight == double.infinity || constraints.maxHeight == double.negativeInfinity || height == null) height = widget.model.calculateMaxHeight() ?? constraints.maxHeight;
    if (constraints.maxWidth  == double.infinity || constraints.maxWidth  == double.negativeInfinity || width  == null) width  = widget.model.calculateMaxWidth()  ?? constraints.maxWidth;
