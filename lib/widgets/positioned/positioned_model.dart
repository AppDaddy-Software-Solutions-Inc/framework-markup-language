...
class PositionedModel extends DecoratedWidgetModel implements IViewableWidget
{
  //////////////
  /* rotation */
  //////////////
  ...
  set left (dynamic v)
  {
    ...
    else if (v != null)
    {
      ...
      _left = DoubleObservable(Binding.toKey(id, 'left'), v, scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set right (dynamic v)
  {
    ...
    else if (v != null)
    {
      ...
      _right = DoubleObservable(Binding.toKey(id, 'right'), v, scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set top (dynamic v)
  {
    ...
    else if (v != null)
    {
      ...
      _top = DoubleObservable(Binding.toKey(id, 'top'), v, scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set bottom (dynamic v)
  {
    ...
    else if (v != null)
    {
      ...
      _bottom = DoubleObservable(Binding.toKey(id, 'bottom'), v, scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set xoffset (dynamic v)
  {
    ...
    {
      _xoffset = DoubleObservable(Binding.toKey(id, 'xoffset'), v, scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set yoffset (dynamic v)
  {
    ...
    {
      _yoffset = DoubleObservable(Binding.toKey(id, 'yoffset'), v, scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set depth (dynamic v)
  {
    ...
    {
      _depth = DoubleObservable(Binding.toKey(id, 'depth'), v, scope: scope, listener: onPropertyChange);
    }
  }
