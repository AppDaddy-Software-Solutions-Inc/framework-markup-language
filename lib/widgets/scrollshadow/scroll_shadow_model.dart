...
class ScrollShadowModel extends ViewableWidgetModel {
  ...
  set left(dynamic v) {
    if (_left != null) {
      ...
      _left = BooleanObservable(Binding.toKey(id, 'left'), v,
  ...
  set right(dynamic v) {
    if (_right != null) {
      ...
      _right = BooleanObservable(Binding.toKey(id, 'right'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set up(dynamic v) {
    if (_up != null) {
      ...
      _up = BooleanObservable(Binding.toKey(id, 'up'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set down(dynamic v) {
    if (_down != null) {
      ...
      _down = BooleanObservable(Binding.toKey(id, 'down'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
