...
class ThemeModel extends DecoratedWidgetModel {
  ...
  set brightness(dynamic v) {
    if (_brightness != null) {
      ...
      _brightness = StringObservable(Binding.toKey('brightness'), v,
  ...
  set colorScheme(dynamic v) {
    if (_colorScheme != null) {
      ...
      _colorScheme = ColorObservable(Binding.toKey('colorscheme'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set font(dynamic v) {
    if (_font != null) {
      ...
      _font = StringObservable(Binding.toKey('font'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set onBackground(dynamic v) {
    if (_onBackground != null) {
      ...
      _onBackground = ColorObservable(Binding.toKey('onbackground'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set shadow(dynamic v) {
    if (_shadow != null) {
      ...
      _shadow = ColorObservable(Binding.toKey('shadow'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set outline(dynamic v) {
    if (_outline != null) {
      ...
      _outline = ColorObservable(Binding.toKey('outline'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set surface(dynamic v) {
    if (_surface != null) {
      ...
      _surface = ColorObservable(Binding.toKey('surface'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set onSurface(dynamic v) {
    if (_onSurface != null) {
      ...
      _onSurface = ColorObservable(Binding.toKey('onsurface'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set surfaceVariant(dynamic v) {
    if (_surfaceVariant != null) {
      ...
      _surfaceVariant = ColorObservable(Binding.toKey('surfacevariant'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set onSurfaceVariant(dynamic v) {
    if (_onSurfaceVariant != null) {
      ...
      _onSurfaceVariant = ColorObservable(Binding.toKey('onsurfacevariant'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set inverseSurface(dynamic v) {
    if (_inverseSurface != null) {
      ...
      _inverseSurface = ColorObservable(Binding.toKey('inversesurface'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set onInverseSurface(dynamic v) {
    if (_onInverseSurface != null) {
      ...
      _onInverseSurface = ColorObservable(Binding.toKey('oninversesurface'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set primary(dynamic v) {
    if (_primary != null) {
      ...
      _primary = ColorObservable(Binding.toKey('primary'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set primaryContainer(dynamic v) {
    if (_primaryContainer != null) {
      ...
      _primaryContainer = ColorObservable(Binding.toKey('primarycontainer'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set onPrimaryContainer(dynamic v) {
    if (_onPrimaryContainer != null) {
      ...
      _onPrimaryContainer = ColorObservable(
          Binding.toKey('onprimarycontainer'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set inversePrimary(dynamic v) {
    if (_inversePrimary != null) {
      ...
      _inversePrimary = ColorObservable(Binding.toKey('inverseprimary'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set secondary(dynamic v) {
    if (_secondary != null) {
      ...
      _secondary = ColorObservable(Binding.toKey('secondary'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set onSecondaryContainer(dynamic v) {
    if (_onSecondaryContainer != null) {
      ...
      _onSecondaryContainer = ColorObservable(
          Binding.toKey('onsecondarycontainer'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set tertiaryContainer(dynamic v) {
    if (_tertiaryContainer != null) {
      ...
      _tertiaryContainer = ColorObservable(
          Binding.toKey('tertiarycontainer'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set onTertiaryContainer(dynamic v) {
    if (_onTertiaryContainer != null) {
      ...
      _onTertiaryContainer = ColorObservable(
          Binding.toKey('ontertiarycontainer'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set error(dynamic v) {
    if (_error != null) {
      ...
      _error = ColorObservable(Binding.toKey('error'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set onError(dynamic v) {
    if (_onError != null) {
      ...
      _onError = ColorObservable(Binding.toKey('onerror'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set errorContainer(dynamic v) {
    if (_errorContainer != null) {
      ...
      _errorContainer = ColorObservable(Binding.toKey('errorcontainer'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set onErrorContainer(dynamic v) {
    if (_onErrorContainer != null) {
      ...
      _onErrorContainer = ColorObservable(Binding.toKey('onerrorcontainer'), v,
          scope: scope, listener: onPropertyChange);
    }
  }
