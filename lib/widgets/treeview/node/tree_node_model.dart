...
class TreeNodeModel extends DecoratedWidgetModel implements IViewableWidget
{
  ...
  set expandedicon (dynamic v)
  {
    ...
    {
      _expandedicon = IconObservable(Binding.toKey(id, 'icon'), v, scope: scope, listener: onPropertyChange);
    }
  }
  ...
  set expanded (dynamic v)
  {
    ...
    {
      _expanded = BooleanObservable(Binding.toKey(id, 'expanded'), v, scope: scope, listener: onPropertyChange);
    }
  }
  ...
  @override
  Widget getView({Key? key}) => TreeNodeView(this);
}
